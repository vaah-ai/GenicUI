...
import { AUTH_REGEX, AuthError } from './types.js';
/**
 ...
 */
export function parseBearerKey(header) {
    if (!header) {
        return null;
    }
 ...
 */
export function parseApiKeyInfo(key) {
 ...
 */
export function validateKey(key, storedHashes, rejectTestKeys) {
