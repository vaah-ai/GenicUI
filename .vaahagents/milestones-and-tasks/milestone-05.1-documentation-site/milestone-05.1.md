...
- **Workspace topology:** Docus layer lives at `examples/docs/` (sibling to `examples/playground/`) — not at top-level `docs/` because the latter is currently the live requirements tree being migrated in T2.
