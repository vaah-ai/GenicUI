...
> **Last updated by:** M5.1 status sync — T1-T10 + T13 ✅ Complete, T11+T12 🟠 Deferred (manual-verified ACs pending user action)
> **Development phase:** Testable MVP — 32 features / 93 ACs, 8-12 weeks, single maintainer
> **Status:** 5/7 milestones complete (M1–M5 done) · 41/49 tasks complete · 8 tasks not started (M5.1-T14/T15 + M6)
...
### M5.1 — Documentation Site (Docus + Vercel) (11/15 complete)
