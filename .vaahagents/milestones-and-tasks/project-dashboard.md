...
> **Status:** 0/7 milestones complete · 0/30 tasks complete · 30 tasks not started
...
|---|---|---|---|---|---|---|---|---|
| M1 | Foundations: Core Package | Foundations | W1 | ⚪ Not Started | Critical | 7-10 days | 5 | F1, F2, F3, F4, F5 |
...
### M1 — Foundations: Core Package (0/5 complete)

| ID | Title | Status | Priority | Effort | Manifest | Dependencies |
|---|---|---|---|---|---|---|
| M1-T1 | @genicui/core package skeleton | ⚪ Not Started | Critical | 1 day | F1 | None (zero-dependency foundation) |
