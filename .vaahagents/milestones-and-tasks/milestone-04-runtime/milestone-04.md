...
- M4-T3 — GenicElement Web Component base class (maps to manifest F21)
- M4-T4 — Server-side event application (maps to manifest F24)
...
- **Blocks:** M5 (Registry — F37 uses runtime), M7 (Deployment)
- **Requires:** M3-T6 (F18 — subscribe_to_events), M1-T4 (F4 — JSON-Patch), M1-T5 (F5 — session store), M2-T3 (F11 — frames)
