...
| `docs/nuxt.config.ts` | Docus layer wiring | Any nuxt edit |
| `docs/app/app.config.ts` | Nuxt UI v4 brand config | Step 6 (when theme-relevant) |
| `docs/content.config.ts` | Nuxt Content v3 collections | Any content authoring |
| `docs/content/**/*.md` | All authored pages | Authoring steps |
| `docs/.navigation.yml` | IA tree | Step 5, 6 |
